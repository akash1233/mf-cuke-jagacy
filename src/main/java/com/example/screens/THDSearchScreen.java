 ...
 */
public class THDSearchScreen {
    private Session session;
    private String screenCrc = "0x5ac23f10";

    // Screen fields
    private LabelField waitForLabel = new LabelField(3, 4, "Enter LOGON parameters below:");
    ...
    public THDSearchScreen(final Session s) throws JagacyException {
        this.session = s;
